...
class PageEvents extends StatefulWidget {
  @override
  _PageEvents createState() => _PageEvents();
}

class _PageEvents extends State<PageEvents> {
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            ...
            Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.of(context).pushReplacementNamed('/events/add');
                  },
                  child: Icon(
                    Icons.add,
                    size: 26.0,
  ...
  Future<List<DisplayCard>> asd() async {
    ...
    databaseRef = fb.database().ref(region!).child("events");
