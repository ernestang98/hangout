...
class PageFoodOptions extends StatefulWidget {
  @override
  _PageFoodOptions createState() => _PageFoodOptions();
}

class _PageFoodOptions extends State<PageFoodOptions> {
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.of(context)
                        .pushReplacementNamed('/foodoptions/add');
                  },
                  child: Icon(
                    Icons.add,
                    size: 26.0,
  ...
  Future<List<DisplayCard>> asd() async {
    ...
    databaseRef = fb.database().ref(region!).child("food_options");
