...
class PageFoodOptionsAdd extends StatefulWidget {
  const PageFoodOptionsAdd({Key? key}) : super(key: key);
  @override
  _PageFoodOptionsAdd createState() => _PageFoodOptionsAdd();
}

class _PageFoodOptionsAdd extends State<PageFoodOptionsAdd> {
                                ...
                                onPressed: () async {
                                  if (formkey.currentState!.validate()) {
                                    ...
                                    Navigator.of(context)
                                        .pushReplacementNamed('/foodoptions');
                                  } else {
                                    print("Not Validated");
                                  }
                                },
