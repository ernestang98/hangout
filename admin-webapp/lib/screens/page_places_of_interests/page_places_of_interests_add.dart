...
class PagePlacesOfInterestsAdd extends StatefulWidget {
  const PagePlacesOfInterestsAdd({Key? key}) : super(key: key);
  @override
  _PagePlacesOfInterestsAdd createState() => _PagePlacesOfInterestsAdd();
}

class _PagePlacesOfInterestsAdd extends State<PagePlacesOfInterestsAdd> {
  ...
  void forceRebuild() {
    setState(() {
      base = Scaffold(
        appBar: AppBar(
          title: Text("Add Place of Interest"),
          centerTitle: true,
          actions: <Widget>[
            Padding(
                ...
                child: GestureDetector(
                  onTap: () {
                    Navigator.of(context)
                        .pushReplacementNamed('/placesofinterests');
                  },
                  child: Icon(
                    Icons.backspace,
                    size: 26.0,
                              ...
                              child: TextButton(
                                onPressed: () async {
                                  if (formkey.currentState!.validate()) {
                                    ...
                                    //     .database()
                                    //     .ref(region! + "-places-of-interests");
